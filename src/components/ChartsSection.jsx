...
const NOMES_SECRETARIAS = {
  ...
  '720/001 - SEMA': 'Secretaria de Estado de Meio Ambiente',
  '753/001 - SEAGRI': 'Secretaria de Estado de Agricultura',
  '753/402 - EMATER': 'Empresa de Assistência Técnica e Extensão Rural do Acre',
  '761/001 - SEICT': 'Secretaria de Estado de Indústria, Ciência e Tecnologia',
  '715/205 - JUCEAC': 'Junta Comercial do Estado do Acre',
  '759/001 - SETE': 'Secretaria de Estado de Turismo',
  '761/506 - ANAC': 'Agência de Negócios do Acre',
  '754/001 - SEOP': 'Secretaria de Estado de Obras Públicas',
  '713/001 - SEPLAN': 'Secretaria de Estado de Planejamento',
  '744/201 - DERACRE': 'Departamento de Estradas e Rodagens do Acre',
  '715/210 - AGEAC': 'Agência Reguladora dos Serviços Públicos do Estado do Acre',
  '744/203 - SANEACRE': 'Serviço de Água e Esgoto do Acre',
  '744/001 - SEHURB': 'Secretaria de Estado de Habitação e Urbanismo',
  '760/001 - SEASDH': 'Secretaria de Estado de Assistência Social e Direitos Humanos',
  '717/001 - SEE': 'Secretaria de Estado de Educação',
  '722/001 - SEPI': 'Secretaria de Estado Extraordinária dos Povos Indígenas',
  '744/206 - ITERACRE': 'Instituto de Terras do Acre',
  '448/001 - CGE': 'Controladoria-Geral do Estado',
  '753/401 - CAGEACRE': 'Companhia de Armazéns e Entrepostos do Acre',
  '609/001 - CBMAC': 'Corpo de Bombeiros Militar do Acre',
  '717/303 - FEM': 'Fundação de Cultura e Comunicação Elias Mansour',
  '717/628 - FEM (Fundo Estadual de Cultura  - Funcultura)': 'Fundação de Cultura e Comunicação Elias Mansour - Funcultura',
  '761/309 - FAPAC': 'Fundação de Amparo à Pesquisa do Estado do Acre',
  '761/301 - FUNTAC': 'Fundação de Tecnologia do Estado do Acre',
  '719/209 - IAPEN': 'Instituto de Administração Penitenciária',
  '753/207 - IDAF': 'Instituto de Defesa Agropecuária e Florestal',
  '717/212 - IEPTEC': 'Instituto Estadual de Educação Profissional e Tecnológica',
  '720/202 - IMAC': 'Instituto de Meio Ambiente do Acre',
  '719/213 - ISE': 'Instituto Sócio-Educativo do Acre',
  '451/001 - PCAC': 'Polícia Civil do Estado do Acre',
  '452/001 - DEFESA CIVIL': 'Defesa Civil',
  '608/001 - PMAC': 'Polícia Militar do Estado do Acre',
  '609/632 - CBMAC (Fundo Esp. do Corpo de Bombeiros Militar do Estado do Acre - FUNESBOM)': 'Corpo de Bombeiros Militar do Acre - FUNESBOM',
  '510/001 - PGE': 'Procuradoria Geral do Estado',
  '718/001 - SEEL': 'Secretaria Extraordinária de Esporte e Lazer',
  '445/001 - SEGOV': 'Secretaria de Estado de Governo',
  '719/001 - SEJUSP': 'Secretaria de Estado da Justiça e Segurança Pública',
  '762/001 - SEMULHER': 'Secretaria de Estado da Mulher',
  '721/607 - SESACRE (Fundo Estadual de Saúde - FUNDES)': 'Secretaria de Estado de Saúde do Acre',
  '714/211 - ACREPREVIDÊNCIA': 'Acreprevidência',
  '715/501 - COHAB': 'Companhia de Habitação do Acre',
  '719/216 - PROCON': 'Procon',
  '753/610 - SEAGRI (Fundo Agropecuário - FUNAGRO)': 'Fundo Agropecuário do Acre',
  '760/640 - SEASDH (Fundo Est. Def. Consumidor  - DEFC)': 'Fundo Est. Defesa do Consumidor',
  '760/640 - SEADH (Fundo Estadual de Defesa do Consumidor - FEDC)': 'Fundo Estadual de Defesa do Consumidor',
  '760/608 - SEASDH (Fundo de Assistência Social - FEAS)': 'Fundo de Assistência Social',
  '744/643 - SEHURB (Fundo Est. Esp. Recup. Bacia Igarapé S. Francisco)': 'Fundo Recuperação Bacia Igarapé S. Francisco',
  '744/619 - SEHURB (Fundo Est. Habitação - FEH)': 'Fundo Estadual de Habitação',
  '761/615 - SEICT (Fundo de Desenvolvimento Sustentável - FDS)': 'Fundo de Desenvolvimento Sustentável',
  '719/637 - SEJUSP (Fundo Est. de Segurança - FUNDESEG)': 'Fundo Estadual de Segurança',
  '719/626 - SEJUSP (Fundo Penitenciário do Estado do Acre)': 'Fundo Penitenciário',
  '720/605 - SEMA (Fundo Est. de Comando e Controle Ambiental)': 'Fundo Estadual de Comando e Controle Ambiental',
  '720/622 - SEMA (Fundo Est. de Meio Ambiente e Florestas)': 'Fundo Estadual de Meio Ambiente e Florestas',
